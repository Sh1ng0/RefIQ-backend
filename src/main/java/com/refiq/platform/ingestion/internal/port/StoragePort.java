 ...
 * <p>
 * Defines the contract for storing ingestion files, decoupling the domain
 * from specific storage technologies (e.g., AWS S3, MinIO, local filesystem).
 * </p>
 */
public interface StoragePort {
   ...
   * <p>
   * Reserves the context in the storage system but does not upload data yet.
   * </p>
   *
   * @param key         The destination path/key for the file.
   * @param contentType The MIME type of the file content.
   * @param metadata    The associated file metadata.
