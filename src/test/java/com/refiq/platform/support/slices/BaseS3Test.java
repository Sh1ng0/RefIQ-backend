...
/**
 * Provides a base slice configuration for integration tests requiring both S3 and PostgreSQL.
 * <p>
 * Inherits from {@link BasePostgresTest} to guarantee the database context, and additionally
 * wires the dynamic endpoints and credentials from the shared LocalStack container
